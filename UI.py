...
class Ui:
    ...
    def add_move_indicator_dots(self, points):
        self.move_indicator_dots += points

    def clear_move_indicator_dots(self):
        self.move_indicator_dots = []

    def draw_move_indicator_dots(self):
        for point in self.move_indicator_dots:
